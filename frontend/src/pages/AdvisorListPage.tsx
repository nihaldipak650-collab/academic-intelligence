      ...
      <section className="hero">
        <div className="hero__content">
          ...
          <div className="hero__meta" aria-label="资料概况">
            {phase2Review ? (
              <>
                <span>{advisors.length} 位本地待审核导师</span>
                <span>v1.0.6 隔离映射</span>
                <span>论文检索未执行</span>
              </>
            ) : (
              <>
                <span>{advisors.length} 位本地审核导师</span>
                <span>配置驱动</span>
                <span>人工审核报告</span>
              </>
            )}
            ...
            {filteredAdvisors.map((advisor) => (
              <article className="advisor-card" key={advisor.id}>
                ...
                <div className="advisor-card__body">
                  ...
                  {phase2Review && (
                    <span className="pending-review-chip">待 Owner 人工审核 · 不可发布</span>
                  )}
                  <h3>
                    {advisor.nameZh}
                ...
                <div className="advisor-card__evidence">
                  {phase2Review && (
                    <p className="publication-pending-copy">
                      当前未纳入论文候选证据，代表论文及作者身份尚待检索与核验。
                    </p>
                  )}
                  <ConfidenceTag
